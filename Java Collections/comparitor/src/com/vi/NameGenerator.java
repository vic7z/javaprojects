...
//https://github.com/alexolivero/HoopsGuru/blob/master/src/NameGenerator.java
...
public class NameGenerator {
    ...
    public static String generateWhiteName(){
        String name = white_first_names[
                randInt(0,white_first_names.length - 1)]
                +" "+
                white_last_names[randInt(0, white_last_names.length - 1)];
    ...
    public static String generateBlackName(){
        String name = black_first_names[
                randInt(0,black_first_names.length - 1)]
                +" "+
                black_last_names[randInt(0,black_last_names.length - 1)];
